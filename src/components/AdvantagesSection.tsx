...
const advantages = [
  {
    ...
    description: "Solusi harga yang menyesuaikan budget Anda tanpa mengorbankan kualitas layanan.",
  },
  {
    icon: Clock,
    title: "Operasional 24/7",
    description: "Siap melayani kapan saja Anda butuhkan, setiap hari tanpa libur.",
  },
  {
    icon: Wrench,
    title: "Maintenance Rutin",
    description: "Pengecekan dan perawatan kapal setiap minggu untuk keamanan dan kenyamanan Anda.",
  },
  {
    icon: ClipboardCheck,
    title: "Survei H-1",
    description: "Konfirmasi dan survei kondisi kapal H-1 sebelum keberangkatan untuk memastikan kesiapan.",
  },
  {
    icon: Percent,
  ...
  },
  {
    ...
    description: "Kami berusaha menyediakan semua yang Anda butuhkan untuk perjalanan laut.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Keunggulan yang membuat Rental Boot Batam menjadi pilihan terpercaya sejak 2008
          </p>
        </div>
